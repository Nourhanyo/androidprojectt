...
public class database extends SQLiteOpenHelper {
    ...
    private static String foodtable = "create table foodtable(id integer primary key autoincrement,name text,calories text ,totalfat integer ,satfat integer,cholest integer,carb integer,fiber integer,sugers integer,protein  integer );";
    private static String userdata   = "create table userdata (id integer primary key autoincrement ,name text,  height integer, weight integer, gender text ,targetweight int  );";
    ...
    public boolean insertfooddata(String name,String a,int c,int e ,int t ,int y ,int i ,int o ,int p  ) {
    ...
    public boolean insertdatauser(String name,String gender,int age,int height ,int weidth  , int targetweidth  ) {
        SQLiteDatabase db=this.getWritableDatabase(); //to make it able to write
        ContentValues contentValues= new ContentValues();
        contentValues .put("",name);
        contentValues .put("",age);
        contentValues .put("",height);
        contentValues .put("",weidth);
        contentValues .put("",targetweidth);
